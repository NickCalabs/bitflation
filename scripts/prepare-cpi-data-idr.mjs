...
// FRED series: Indonesia CPI (All Items)
const SERIES_ID = 'IDNCPIALLMINMEI';

async function main() {
  console.log('Fetching Indonesia CPI data from FRED...');
  ...
  console.log(`\nWrote ${entries.length} entries to src/data/idr/cpi-monthly.json`);
}
